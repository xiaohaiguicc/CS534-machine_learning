# -*- coding: utf-8 -*-
"""
Created on Sat Apr 14 15:23:23 2018
...
# -*- coding: utf-8 -*-
"""
Created on Fri Apr 13 11:52:41 2018
...
# Save dir:
save_dir = 'tensorboard/optimizer/adam'
...
def cnn_model_fn(features, labels, mode):
  ...
  if mode == tf.estimator.ModeKeys.TRAIN:
    optimizer = tf.train.AdamOptimizer(learning_rate=learning_rate)#potimized and learning rate can change
