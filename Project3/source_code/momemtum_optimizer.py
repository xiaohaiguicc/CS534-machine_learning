...
# Save dir:
save_dir = 'tensorboard/optimizer/momentum_optimizer'
...
def cnn_model_fn(features, labels, mode):
  ...
  if mode == tf.estimator.ModeKeys.TRAIN:
    optimizer = tf.train.MomentumOptimizer(learning_rate=learning_rate, momentum=0.9)#potimized and learning rate can change
